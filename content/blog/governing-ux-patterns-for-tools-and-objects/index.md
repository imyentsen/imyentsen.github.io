...
![objects and tools, the two things our patterns had to govern](./objectives.jpg "objects and tools, the two things our patterns had to govern.")
...
![my role across the object work and the later pattern audit work](./role.jpg "my role across the object work and the later pattern audit work.")
...
![several list treatments of the same object type, side by side](./challenge-objects.jpg "several list treatments of the same object type, side by side. The diversity without clear logic harmed our UX.")
...
![the same toolbar in two product areas, with the areas ordered differently](./challenge-tools.jpg "the same toolbar in two product areas, with the areas ordered differently.")
...
![the collaborative object and tool map](./objectmap.jpg "the collaborative object and tool map.")
...
![prioritising components against their reach in the product](./priorities.jpg "prioritising components against their reach in the product.")
...
![the pilot Data Label and List components](./pilot.jpg "the pilot Data Label and List components.")
...
![patterns help designers understand how to use several related components](./toolbar-pattern.jpg "patterns help designers understand which kind of component belongs to which area of the product, in what order they are arranged, and which interactions are allowed.")
...
![the guideline extraction and audit flow](./audit-skill.jpg "the guideline extraction and audit flow.")
...
![audit output, placed in Figma as annotations](./audit-output.jpg "the audit output, placed in Figma as annotations.")

# Outcome

## Objects in the digital twin became clear and readable

![Data Label across 2D and 3D environments](./outcome-objects.jpg "Data Label across 2D and 3D environments.")
...
![the toolbar after the work](./outcome-toolbar.jpg "the toolbar after the work.")
...
![toolbar annotation](./outcome-audit.jpg "toolbar annotation.")
...
![the component roadmap, Tree, Card and Tag](./outcome-roadmap.jpg "the component roadmap. Tree, Card and Tag.")
